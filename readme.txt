Problem/Question
	...
	because standard IRC protocols don't provide a recorded chat log; the chat
...
Description
	...
	partial hash tables which can communicate with eachother to lookup entries.
	...
	It represents a simple prototype of a chat system that can be used to store
...
Evaluation
	...
	There were found to be some cases were data could not be found, but this is likely due 
	to certain nodes having well populated routing tables. This is something in particular
	...
	This test shows the correctness of the algorithm essentially by fuzzing the input space.
...
Future Work
	...
	it isn't exactly necessary. Adding the timeouts and conforming to the rest of the spec
